...
router.get('/report/daily', protect, authorize('admin'), getDailyAttendanceReport);
router.get('/report/daily-summary', protect, authorize('admin'), getDepartmentDailySummary);
router.get('/report/student-details', protect, authorize('admin'), getAttendanceStudentDetails);
