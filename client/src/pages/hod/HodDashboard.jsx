    ...
    if (loading) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[400px]">
                ...
                <p className="mt-4 text-gray-500 font-medium">Loading department overview...</p>
            </div>
        );
    }
    ...
    return (
        <div className="max-w-7xl mx-auto space-y-8 animate-fade-in">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    <h2 className="text-3xl font-extrabold text-gray-900 tracking-tight">HOD Dashboard</h2>
                    <p className="text-gray-500 mt-1 text-lg">Managing department statistics and academic approvals.</p>
                </div>
                        ...
                        <div className="group bg-white rounded-2xl p-6 shadow-sm border border-slate-200 hover:shadow-xl hover:border-indigo-200 transition-all duration-300">
                            <div className="flex justify-between items-start mb-6">
                                <div className="p-4 bg-indigo-50 rounded-2xl group-hover:bg-indigo-600 transition-colors duration-300">
                                    <CheckCircle className="h-7 w-7 text-indigo-600 group-hover:text-white" />
                                </div>
                                <Link to="/dashboard/marks-management" className="text-gray-400 hover:text-indigo-600 transition-colors">
                                    <ArrowRight className="h-6 w-6 transform group-hover:translate-x-1 transition-transform" />
                                </Link>
                            </div>
                            <h3 className="text-xl font-extrabold text-gray-900 mb-2">Marks Approval</h3>
                            <p className="text-gray-500 text-sm leading-relaxed mb-6">
                                Review and approve marks submitted by faculty members before final publication.
                            </p>
                            <Link
                        ...
                        <div className="group bg-white rounded-2xl p-6 shadow-sm border border-slate-200 hover:shadow-xl hover:border-purple-200 transition-all duration-300">
                            <div className="flex justify-between items-start mb-6">
                                <div className="p-4 bg-purple-50 rounded-2xl group-hover:bg-purple-600 transition-colors duration-300">
                                    <ClipboardList className="h-7 w-7 text-purple-600 group-hover:text-white" />
                                </div>
                                <Link to="/dashboard/attendance-report" className="text-gray-400 hover:text-purple-600 transition-colors text-xs">
                                    <ArrowRight className="h-6 w-6 transform group-hover:translate-x-1 transition-transform" />
                                </Link>
                            </div>
                            <h3 className="text-xl font-extrabold text-gray-900 mb-2">Attendance Sync</h3>
                            <p className="text-gray-500 text-sm leading-relaxed mb-6">
                                Monitor student attendance trends and faculty regularity across your department.
                            </p>
                            <Link
